...
\begin{itemize}[label={},leftmargin=*]
  \item \textbf{Software Engineer} at \textbf{HubSpot Inc} --- Cambridge, MA \hfill {\em January 2019 -- June 2019}
  \begin{itemize}[label={$\bullet$}]
    \item Created and tested public API endpoints using Java 11 and JUnit
    \item Implemented Java automation against AWS to assist in engineer workflow
    ...
    \item Created and maintained testable Java 11 microsystems within a distributed architecture
    \item 
    \item 
  \end{itemize}
...
\begin{itemize}[label={},leftmargin=*]
  \item \textbf{Experienced:} Java, Golang, , SQL, Git, Docker
  \item \textbf{Proficient:} Javascript (React, Node, ES5/6), HTML, CSS, C, Racket
