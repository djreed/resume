...
\begin{itemize}[label={},leftmargin=*]
  ...
  \begin{itemize}[label={$\bullet$}]
    ...
    \item Saved 20\% on monthly AWS costs via Kubernetes-enabled infrastructure resizing, service autoscaling\\
          during peak and minimum load, and resizing storage clusters (Databases, Elasticsearch) in response to real-time usage
    ...
    \item Deployed and managed the team's internal developer platform, integrating various internal tools and metrics\\
          into a unified web UI and backend
    %\item Built and maintained CI/CD tooling targeting Elixir, Java, Node, Go, handling multiple daily deploys for our largest services
  \end{itemize}
