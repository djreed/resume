...
\begin{itemize}[label={},leftmargin=*]
  ...
  \begin{itemize}[label={$\bullet$}]
    \item Lead design and development of Slack-controllable deployment systems in Java and Python, responsible\\
          for rolling out, autoscaling, and dynamically configuring applications deployed multiple times an hour
