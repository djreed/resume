...
\begin{itemize}[label={},leftmargin=*]
  ...
  \begin{itemize}[label={$\bullet$}]
    ...
    \item Built and maintained Java/Spring, Python/Django, and Go microservices
    \item Maintained build-and-deploy tooling targeting Django, Elixir, Java, Node, and more
