...
\item \textbf{Software Engineer} at \textbf{Virtyx Technologies} --- Quincy, MA \hfill {\em January 2017--August 2017}
  ...
  \item Developed, tested, and deployed RESTful CRUD APIs for software agent data collection, and front-end data retrieval, in Java using the Spring MVC framework
...
\begin{itemize}[label={},leftmargin=*]
\item \textbf{Experienced:} Golang, JavaScript (Node.js), Java, HTML and CSS (Angular, Bootstrap), Git, Elixir (Phoenix), C
\item \textbf{Proficient:} SQL (PostgreSQL), AngularJS, Spring MVC, GNU Make, Docker, Nginx, MIPS Assembly
\item \textbf{Familiar:} LaTeX, MySQL, Scheme, Shell scripting
\end{itemize}
